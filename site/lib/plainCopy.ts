...
const PROSE_PHRASES: [RegExp, string][] = [
  ...
  [/The folder is (`[^`]+`)\./g, "Practice files are in $1."],
  [/The practice folder is (`[^`]+`)\./g, "Practice files are in $1."],
  [/The local check is (`labs\/[^`]+`)\./g, "Practice files are in $1."],
  [/This week's check covers /g, "This week's check is about "],
  [/Check (`fixed\/[^`]+`) against the list above\./g, "Open $1."],
  [/Read (`vulnerable\/[^`]+`)\./g, "Open $1."],
  ...
  [/The app['’]s promise this week is:\s*\*\*this\*\* local check, /g, "What this practice is supposed to show: "],
  [/The app['’]s promise this week is:\s*\*\*this\*\* /g, "What this practice is supposed to show: "],
  [/The app['’]s promise in this practice: /g, "What this practice is supposed to show: "],
  [/The app['’]s promise: /g, "What this practice is supposed to show: "],
  ...
  [/Point at (`[^`]+`) file (`[^`]+`)\./g, "Open $2 in $1."],
  [/Look in (`[^`]+`), starting with (`[^`]+`)\./g, "Open $2 in $1."],
