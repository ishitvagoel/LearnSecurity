...
**Module:** `1.4` — Risk, people, economics, usable security, and resilience
**Authorized scope:** Local course fixture and synthetic SecureCollab description only
...
Learner produces a risk register; local fixture shows unusable recovery as a security failure
