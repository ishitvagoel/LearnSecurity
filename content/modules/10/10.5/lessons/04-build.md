...
Industry “recover” is an outcome. This week's check is about close-without-recovery.

## What the repaired files must show

Open `fixed/ir.py`. Do not treat the snippet as a production incident product.
