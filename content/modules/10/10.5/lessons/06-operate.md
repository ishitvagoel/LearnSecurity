...
Time-to-detect in SIEM can look great while CI’s `close_incident` is always true. Detection must observe **recovery todo is deny**, not alert volume. A note body attached to `incident_closed_without_recovery` is the incident.
