...
A blocked merge is something you still have to notice and recover from, not an excuse to quote the threat-model body in the paging channel. Notice names the change. Recover adds the threat-model id.
