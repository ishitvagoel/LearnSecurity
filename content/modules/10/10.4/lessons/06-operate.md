...
The same feature flags, sidecar debug, and public admin bind that bypass this fixture will also bypass a “scan our canary dashboard” detector. Name those places before you claim recover. A canary-product name is not the rule.
