...
1. who might try (former guardian with a cached chart id — not a live clinic attack);
...
4. next-read after revoke returns None — **local** practice files (no live clinic system);
