...
Do not try live-target steps. Do not follow vendor prescriptions. Do not copy the notes-app table with the nouns swapped. Answer keys are not on this site.
