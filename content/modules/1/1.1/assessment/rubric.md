...
1. a scoped notes-app product model for this stage;
2. at least five rule rows with complete claim envelopes;
...
|---|---|---|---|
| Property and scope | Topic, CIA label, tool, or universal claim | At least five bounded the notes app rules name assets, subject/action, what must not happen, non-goals, and scope | CivicClinic claims are independently bounded rather than copied |
...
| Communication and editorial integrity | Vague “more detail” comments or reviewer stamp as proof | At least four actionable comments identify unsupported conclusion, missing model, consequence, minimum change, and evidence | Comparison memo clearly explains which the notes app claims fail and why |
...
- **Competent:** all critical and supporting dimensions are satisfactory for the notes app.
- **Transfer-ready:** competent plus satisfactory independent CivicClinic evidence and comparison memo.

This module contributes to check-in 1; it does not complete check-in 1 by itself.
