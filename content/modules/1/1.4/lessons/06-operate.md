...
A broken recovery widget still has to be noticed. Support must not read codes aloud. The alternate path must still be a checked, usable control. The notice should name keyboard vs mouse. Recovery should restore access. Neither emails notes.
