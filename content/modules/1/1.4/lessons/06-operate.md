...
A broken recovery widget is something you still have to notice and recover from, not an excuse to let support read codes aloud. The alternate path must still be a checked, usable control. Notice names keyboard vs mouse. Recover restores access. Neither emails notes.
