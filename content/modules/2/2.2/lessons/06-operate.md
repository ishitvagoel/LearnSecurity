...
A wrong cache hit still has to show up as an alert. The body does not belong in the log. The alert should name the mismatch. Then purge. Neither writes `tenant-A-note`.
