...
A missing HttpOnly flag is something you still have to notice and recover from, not an excuse to paste the session into a ticket. The notice should name the cookie. Recover rotates it. Neither logs the value.
