...
What this practice is supposed to show: `sc_session` object in the practice is unread by `js_read_session` when `httponly` is true. The local check is `labs/2.3/2.3-browser-policy`. It is not a live browser exploit page.
