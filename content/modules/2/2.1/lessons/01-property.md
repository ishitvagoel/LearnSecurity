...
What this practice is supposed to show: the ingest function, on this practice object, either refuses the messy object or yields `acl_tenant == stored_tenant`. Practice files are in `labs/2.1/2.1-parser-boundaries`. It is not a live API and not a public JSON fuzzer.
