...
What this practice is supposed to show: `accept` check, on **this** practice string, is false when the signature is missing — files in `labs/7.3/7.3-lab`. Local only. No live webhooks.
