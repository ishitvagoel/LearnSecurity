...
A deny of a callback with a missing or wrong MAC still has to be noticed and recovered from — not an excuse to paste the body into the paging channel. Recovery should keep the deny. Neither logs the body.
