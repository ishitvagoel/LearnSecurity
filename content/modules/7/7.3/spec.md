...
1. Produce **Signed webhook protocol, replay tests, provider-failure runbook** for SecureCollab (or the elective system).
...
API10; ASVS V4/V11/V12 — label drafts (OAuth 2.1, SSDF 1.2, Privacy FW 1.1, WebAuthn L3 CR, NIST 800-154, CSP3, Trusted Types) as non-final. ASVS IDs when pinned later: `v5.0.0-…`. No ASVS 4.x. No MASVS L1/L2/R.
...
Blueprint §9.1 phase evolution. Evidence: Signed webhook protocol, replay tests, provider-failure runbook.
