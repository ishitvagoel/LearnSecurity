...
Object, property, and function security

## Evidence checklist

- [ ] Policy-aware serializers and authorization mutation tests
...
Use the local `vulnerable/` artifact. Intended findings live only in `content/assessment/keys/7.2.md`.
