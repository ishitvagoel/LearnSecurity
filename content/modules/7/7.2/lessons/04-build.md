...
Industry lists ask for that explicit permission implemented. The check below is that sentence for member × `secret_internal`. Applying a role change through every serializer right away is **advanced**, not this week's check.
