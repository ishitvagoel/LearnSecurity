...
That explicit permission has to be implemented — member × `secret_internal`. Applying a role change through every serializer right away is **advanced**, not this week's check.
