...
That explicit permission has to be implemented. This week's check looks at member × `secret_internal`. Applying a role change through every serializer right away is **advanced**, not this week's check.
