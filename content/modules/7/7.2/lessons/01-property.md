# 7.2-LO-01 — Object, property, and function security: property vs mechanism
...
What must remain true of **SecureCollab** (or the elective system) regarding **Object, property, and function security** when an attacker with stated capabilities acts, a component fails, or a human follows a stressful recovery path?
...
| Slice | For Object, property, and function security |
|---|---|
...
FastAPI, Next.js, PostgreSQL, or Android “secure defaults” are not the application guarantee for **Object, property, and function security**. Name what the app must still enforce.
...
Complete the associated lab under `labs/7.2/` if a labSpec exists. Observe the forbidden outcome on `vulnerable/`. Do not target non-lab systems. Do not copy weaponized payloads into notes.

Safe task: write one testable sentence that would fail if the **object** property were false.
...
- Object, property, and function security is a Top 10 memorization exercise
