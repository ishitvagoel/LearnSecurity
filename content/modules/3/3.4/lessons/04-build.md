...
The smallest fix for share is: if count is already 5, return 5 and do not insert. Fail closed: if the count store is uncertain, **deny** the 6th. Five honest shares still succeed.
