...
- [ ] Lab `labs/3.4/3.4-lab`: what must not happen: **Share grants exceed the product cap of 5**
...
| Competent | System-specific rule; lab mapped; operate present; API4/API6 labeled awareness |
