...
What this practice is supposed to show: `log_event` line does not contain `tenant-A-secret-body` and does contain a redaction marker. The local check is `labs/3.1/3.1-lab`. Fake data only. No real people's data. No production log drain.
