...
A clinic change that “enabled R8 and Play App Signing” without a debug-to-prod deny check is an incomplete channel review. What would still keep a debug build from calling prod even if R8 is on?
