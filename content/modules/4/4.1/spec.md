...
1. Produce **Account-lifecycle state machine, recovery threat model** for SecureCollab (or the elective system).
...
NIST SP 800-63-4; ASVS V6 — label drafts (OAuth 2.1, SSDF 1.2, Privacy FW 1.1, WebAuthn L3 CR, NIST 800-154, CSP3, Trusted Types) as non-final. ASVS IDs when pinned later: `v5.0.0-…`. No ASVS 4.x. No MASVS L1/L2/R.
...
Blueprint §9.1 phase evolution. Evidence: Account-lifecycle state machine, recovery threat model.
