...
“User disabled” on the identity-provider tile will not notice a self-contained token that still verifies. Confirm **session_valid after deleted**, not the HR ticket. SessionMiddleware does not emit this alert for you.
