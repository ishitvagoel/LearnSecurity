...
What this practice is supposed to show: `tenant_for`, session A plus body B is A. Practice files are in `labs/E5/e5-lab`. It is local only. It is not a live company.
