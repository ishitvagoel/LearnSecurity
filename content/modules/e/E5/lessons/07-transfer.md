...
4. a check on **local** practice files only (no public clinic system);
...
Bind company from the session, not the JSON body. Keep the answer keys closed. `labs/E5/e5-lab` is the only running system you may break. Do not probe a live company.
