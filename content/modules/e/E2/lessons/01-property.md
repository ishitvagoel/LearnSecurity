# E2-LO-01 — Advanced browser and edge security: property vs mechanism
...
What must remain true of **SecureCollab** (or the elective system) regarding **Advanced browser and edge security** when an attacker with stated capabilities acts, a component fails, or a human follows a stressful recovery path?
...
| Slice | For Advanced browser and edge security |
|---|---|
...
FastAPI, Next.js, PostgreSQL, or Android “secure defaults” are not the application guarantee for **Advanced browser and edge security**. Name what the app must still enforce.
...
Complete the associated lab under `labs/E2/` if a labSpec exists. Observe the forbidden outcome on `vulnerable/`. Do not target non-lab systems. Do not copy weaponized payloads into notes.

Safe task: write one testable sentence that would fail if the **advanced** property were false.
...
- Advanced browser and edge security is a Top 10 memorization exercise
