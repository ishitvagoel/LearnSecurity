...
The notes app’s Next.js responses needs this: Report-Only only → false, enforcing CSP may count. Keep it closed even if reports are arriving. Do not treat a policy string on the wrong header as isolation.
