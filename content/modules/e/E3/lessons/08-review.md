...
Hold onto two k1 → count 1. If that call is missing key identity, you still have an always-append leftover. A questionnaire screenshot without that check is still the same problem.
