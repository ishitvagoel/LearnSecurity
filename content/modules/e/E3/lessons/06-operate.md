...
A processor dashboard will show successful captures and stay silent when CI’s `capture` always appends. Notice must observe **two k1 → count 1**, not processor 200s. A card number next to two-k1-count-1 reopens topic 5.1 this elective forbids.
...
A card number, a note body, or “questionnaire complete” would leak PAN-like data.
