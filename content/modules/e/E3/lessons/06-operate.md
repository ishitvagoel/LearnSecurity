...
Processor capture success does not mean CI’s `capture` rejected a duplicate key. Count **two k1 → count 1**, not processor 200s. A card number next to two-k1-count-1 reopens topic 5.1 this elective forbids.
