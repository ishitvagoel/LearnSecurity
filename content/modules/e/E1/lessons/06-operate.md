...
The same lying `search_notes` HTML, hallucinated packages, and prompt-only policy that bypass this fixture will also bypass a "scan our agent dashboard" detector. Name those places before you claim recover. A vendor-product name is not the rule.
