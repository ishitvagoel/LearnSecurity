...
What this practice is supposed to show: `allowed` check, on **this** practice string, is false for link-local metadata. Practice files are in `labs/6.5/6.5-lab`. Fake URLs only. No live fetch.
