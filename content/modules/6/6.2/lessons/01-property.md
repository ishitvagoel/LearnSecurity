...
What this practice is supposed to show: `render`, on **this** practice title, turns `<` into `&lt;` in HTML text. Practice files are in `labs/6.2/6.2-lab`. It is not a live page and not a public site.
