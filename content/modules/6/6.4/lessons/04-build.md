...
For uploads: deny if not under the folder. Unless you know otherwise, if canonicalize is uncertain, **deny**. Do not allow just because the name “looks like notes/a.txt.”
