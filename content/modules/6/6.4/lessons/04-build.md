...
For uploads: deny if not under the folder. Unless you know otherwise, if canonicalize is uncertain, **deny**. Don't allow it just because the name “looks like notes/a.txt.”
