...
Put this in a invite: write used, then allow once. By default, store errors **deny**. Don't count a pass just because the database was unreachable. Production uses a transaction so the used-write and the membership commit together.
