...
Use anti-forgery tokens or extra headers a simple form cannot set. This week's check covers `allow_share`. Extra rows about authenticated embeds and CORP are **advanced** — not this week's check.
