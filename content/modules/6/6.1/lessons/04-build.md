...
The check in export listing: list, not string. In doubt, if you cannot spawn without a shell, **do not spawn**. That still denies — even if the name “looks like notes.”
