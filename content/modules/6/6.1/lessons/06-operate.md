...
Someone still has to notice, respond, and recover. That work does not build argv. A vendor name is not this week's rule. Someone still has to own the concatenating path.
