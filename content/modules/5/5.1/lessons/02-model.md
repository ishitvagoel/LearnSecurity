...
Look in `labs/5.1/5.1-lab`, starting with `lifecycle.py`. Your artifact is a versioned list (even a table in your notes) with copy, allow or deny, and what would show the deny is false. Fake data only.
