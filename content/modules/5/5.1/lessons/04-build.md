...
Industry lists ask for sensitive data not sent to an untrusted second party. This week's check is the deletion half of that sentence: if analytics already has the body, delete must still walk it. A scheduled automatic deletion job is advanced work, not this check.

## What the repaired files must show

Read `fixed/lifecycle.py` against this checklist. Do not treat the snippet as a production warehouse.
