...
Look in `labs/5.4/5.4-lab`, starting with `channel.py`. Your artifact is a versioned list (even a table in your notes) with hop, who may assert proto, allow or deny, and what would show the deny is false. Fake data only.
