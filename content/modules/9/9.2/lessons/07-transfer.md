...
| `'eval(' not in diff` stand-in | Same stand-in on local practice files |
...
4. stay on **local** practice files only (no weaponized eval — never on the real clinic);
