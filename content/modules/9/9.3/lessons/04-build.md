...
The check in the notes app’s isolation suite: 200-only → not a security test. Missing flag is false. Don't open it just because coverage is 94%. Do not accept a fuzzer with no named bad result as the flag.
