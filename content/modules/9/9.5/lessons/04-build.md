...
Repair the notes app's close loop: `{retest: None}` cannot close. A missing field is deny. The deny still holds even if the report was filed. Do not accept a retest of `/health` as the isolation check.
