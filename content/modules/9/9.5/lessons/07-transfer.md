...
Here, a clinic chart is still this topic’s note. Name the rule, the retest, and what still changes after close. Filing the PDF and marking the ticket Done does not set `retest` to `"pass"`.
