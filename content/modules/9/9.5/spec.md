# 9.5 — Penetration testing, reporting, and remediation
...
- **id:** 9.5
- **slug:** penetration-testing-reporting-and-remediation
- **title:** Penetration testing, reporting, and remediation
...
1. Produce **Assessment report, remediation plan, retest record** for SecureCollab (or the elective system).
...
OWASP WSTG; MASTG; CVSS 4.0; CISA KEV — label drafts (OAuth 2.1, SSDF 1.2, Privacy FW 1.1, WebAuthn L3 CR, NIST 800-154, CSP3, Trusted Types) as non-final. ASVS IDs when pinned later: `v5.0.0-…`. No ASVS 4.x. No MASVS L1/L2/R.
...
Blueprint §9.1 phase evolution. Evidence: Assessment report, remediation plan, retest record.
