...
What this practice is supposed to show: `ship_ok` with a HIGH and an empty map is deny. Practice files are in `labs/9.4/9.4-lab`. Fake finding id `F1` only. No live GitHub. No scanning other people’s repos.
