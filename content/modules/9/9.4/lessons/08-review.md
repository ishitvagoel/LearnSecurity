...
Hold onto unmapped HIGH denied. If that call is missing a join to the coverage map, you still have an always-ship leftover. A scanner screenshot without that check is still the same problem.
