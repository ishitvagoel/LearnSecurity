...
Vendor finding counts do not mean CI’s `ship_ok` maps HIGH. Detection must observe **empty map plus HIGH is deny**, not alert volume. A secret or a note body next to that empty-map deny is a log-line leak and an extra vendor copy.
