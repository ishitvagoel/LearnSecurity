...
The notes app’s AUTHZ-1 tracking needs this: status-only → not covered. A missing flag is false. Don't waive the deny just because the PDF was attached. Do not accept “we ran the checklist” as the isolation flag.
